    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (isVisible) {
                ...
                articulo12.setText(savedInstanceState.getString("reply_articulo11"));
                articulo12.setVisibility(View.VISIBLE);

                articulo13.setText(savedInstanceState.getString("reply_articulo11"));
                articulo13.setVisibility(View.VISIBLE);

                articulo14.setText(savedInstanceState.getString("reply_articulo11"));
                articulo14.setVisibility(View.VISIBLE);

                articulo15.setText(savedInstanceState.getString("reply_articulo11"));
                articulo15.setVisibility(View.VISIBLE);

                articulo16.setText(savedInstanceState.getString("reply_articulo11"));
        ...
        if (requestCode==TEXT_REQUEST){
            if(resultCode==RESULT_OK) {
                ...
                if(count==12){
                    ...
                    String agregar11 =data.getStringExtra(AgregarArticulo.EXTRA_MESSAGE);
                    articulo12.setText(agregar11);
                }
                if(count==13){

                    String agregar11 =data.getStringExtra(AgregarArticulo.EXTRA_MESSAGE);
                    articulo13.setText(agregar11);
                }
                if(count==14){

                    String agregar11 =data.getStringExtra(AgregarArticulo.EXTRA_MESSAGE);
                    articulo14.setText(agregar11);
                }
                if(count==15){

                    String agregar11 =data.getStringExtra(AgregarArticulo.EXTRA_MESSAGE);
                    articulo15.setText(agregar11);
                }
                if(count==16){

                    String agregar11 =data.getStringExtra(AgregarArticulo.EXTRA_MESSAGE);
                    articulo16.setText(agregar11);
                }
                count=count+1;
            }
        }
...
public void onSaveInstanceState(Bundle outState) {
    ...
    outState.putString("reply_articulo12", articulo11.getText().toString());
    outState.putString("reply_articulo13", articulo11.getText().toString());
    outState.putString("reply_articulo14", articulo11.getText().toString());
    outState.putString("reply_articulo15", articulo11.getText().toString());
    outState.putString("reply_articulo16", articulo11.getText().toString());
